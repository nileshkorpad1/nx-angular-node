...
A todo list of accessibility actions and related information can be found [here](https://github.com/oneghx/mp-marketplace-frontend/wiki/Accessibility).
...
```json
{
  ...
  "urls": ["http://localhost:4200/page1", "http://localhost:4200/page2"]
}
```
